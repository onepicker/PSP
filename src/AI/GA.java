...
public class GA {
    ...
    private void init(String filename) throws IOException {
        ...
        for (int i = 0; i < cityNum; i++) {
            ...
            x[i] = Integer.parseInt(strcol[1]);// x坐标
            y[i] = Integer.parseInt(strcol[2]);// y坐标
        }
        // 计算距离矩阵
    ...
    private void init2(String filename) throws IOException {
        String strbuff;
        BufferedReader data = new BufferedReader(new InputStreamReader(
                new FileInputStream(filename)));
        distance = new int[cityNum][cityNum];
        ...
        for (int i = 0; i < cityNum-1; i++) {
            ...
            int count = 0;
            for (int j = i+1;j < cityNum;j++){
                distance[i][j] = distance[j][i] = Integer.parseInt(strcol[count++]);
            }
        }
    ...
    private void init3(String filename) throws IOException {
        String strbuff;
        BufferedReader data = new BufferedReader(new InputStreamReader(
                new FileInputStream(filename)));
        distance = new int[cityNum][cityNum];
        ...
        for (int i = 0; i < cityNum; i++) {
            ...
            for (int j = 0;j < cityNum;j++){
                distance[i][j] = Integer.parseInt(strcol[count++]);
            }
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        GA ga = new GA(10, 8, 40, 0.8f, 0.9f);
        ga.init3("C:\\Users\\86134\\Desktop\\作业\\人工智能\\实验三源代码\\data3.txt");
        ga.solve();
    }
